 ...
 * @author amir.afghani
 */
public class PokerFiveHandClassifier implements HandClassifier {

    private final RankGroup rankGroup;
    private final SuitGroup suitGroup;
    private final SortedSet<Card> cards;

    PokerFiveHandClassifier(final RankGroup rankGroup,
    ...
    private Classification detectWheel() {
        final List<Rank> wheelRanks = Arrays.asList(Rank.A, Rank.TWO, Rank.THREE, Rank.FOUR, Rank.FIVE);
...
//    private Classification detectFiveOfAKind(){
//        
//    }
